...
let%expect_test "Time_ns.Span.Stable.V1" =
  ...
  [%expect
    ...
    ((sexp   11.2754s)
     ...
     (int63  11275440000))
    (* require-failed: test/src/test_time_ns.ml:LINE:COL. *)
    ...
    let%expect_test "of_span_float_round_nearest_microsecond +/-140y raises" =
      ...
      [%expect
        ...
        ("Time_ns.Span does not support this span"
         51240d
         duniverse/core_kernel/src/span_ns.ml:LINE:COL)
        ("Time_ns.Span does not support this span"
         -51240d
         duniverse/core_kernel/src/span_ns.ml:LINE:COL) |}]
    ;;
...
let%test_module "Time_ns.Option" =
  (module struct
    ...
    let%expect_test "value_exn none" =
      ...
      [%expect
        {| (src/core_time_ns.ml:LINE:COL "Span.Option.value_exn none") |}]
    ;;
  end)
;;
